...
HXDLIN(2113)								i = (i - 1);
HXDLIN(2113)								::cpp::VirtualArray this2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(2113)								this1->__SetField(HX_("__tempIndex",3e,e8,54,22),(i + 1),::hx::paccDynamic);
HXDLIN(2113)								{
HXLINE(2113)									int _g_current = 0;
HXDLIN(2113)									::cpp::VirtualArray _g_args = this2;
HXDLIN(2113)									while((_g_current < _g_args->get_length())){
HXLINE(2113)										_g_current = (_g_current + 1);
HXDLIN(2113)										 ::Dynamic item = _g_args->__get((_g_current - 1));
HXDLIN(2113)										( ( ::openfl::_Vector::ObjectVector)(this1) )->insertAt(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( ( ::openfl::text::_internal::TextFormatRange)(item) ));
...
HXDLIN(2232)						goto _hx_goto_67;
            					}
            					if (  (_hx_switch_0==3) ){
HXLINE(2229)						Float _hx_tmp = this->get_x();
HXDLIN(2229)						this->set_x((_hx_tmp + (cacheWidth - this->_hx___textEngine->width)));
HXDLIN(2229)						goto _hx_goto_67;
            					}
            					/* default */{
            					}
            					_hx_goto_67:;
...
HXLINE(2384)			int _hx_tmp = this->get_scrollH();
HXDLIN(2384)			Float _hx_tmp1 = this->get_mouseX();
HXDLIN(2384)			this->set_scrollH((_hx_tmp + ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min(((_hx_tmp1 - this->get_width()) * ((Float).1)),( (Float)(10) )),( (Float)(1) )))));
            		}
            		else {
HXLINE(2386)			if ((this->get_mouseX() < 1)) {
HXLINE(2388)				int _hx_tmp = this->get_scrollH();
HXDLIN(2388)				this->set_scrollH((_hx_tmp - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((this->get_mouseX() * ((Float)-.1)),( (Float)(10) )),( (Float)(1) )))));
            			}
            		}
...
HXLINE(2401)					int _hx_tmp = this->get_scrollV();
HXDLIN(2401)					this->set_scrollV((_hx_tmp - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((this->get_mouseY() * ((Float)-.03)),( (Float)(5) )),( (Float)(1) )))));
            				}
            			}
...
HXLINE(2422)			_hx_tmp = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXLINE(2879)				_hx_tmp = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(2934)					_hx_tmp = ::hx::IsInstanceNotEq( value,this->_hx___styleSheet );
            				}
            				else {
...
HXDLIN(2978)			int deleteCount = (this->_hx___textEngine->textFormatRanges->get_length() - 1);
HXDLIN(2978)			::cpp::VirtualArray this2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(2978)			this1->__SetField(HX_("__tempIndex",3e,e8,54,22),1,::hx::paccDynamic);
HXDLIN(2978)			{
HXLINE(2978)				int _g_current = 0;
HXDLIN(2978)				::cpp::VirtualArray _g_args = this2;
HXDLIN(2978)				while((_g_current < _g_args->get_length())){
HXLINE(2978)					_g_current = (_g_current + 1);
HXDLIN(2978)					 ::Dynamic item = _g_args->__get((_g_current - 1));
HXDLIN(2978)					( ( ::openfl::_Vector::ObjectVector)(this1) )->insertAt(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( ( ::openfl::text::_internal::TextFormatRange)(item) ));
HXDLIN(2978)					::hx::FieldRef((this1).mPtr,HX_("__tempIndex",3e,e8,54,22))++;
            				}
            			}
HXDLIN(2978)			( ( ::openfl::_Vector::ObjectVector)(this1) )->splice(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),deleteCount);
            		}
...
HXLINE(3175)		if (::hx::IsInstanceEq( stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE(3224)				_hx_tmp = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(3314)			::Array< ::String > delimiters = ::Array_obj< ::String >::fromData( _hx_array_data_efd5a8ca_158,13);
...
HXLINE(3575)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3577)						this->setSelection(0,this->_hx___text.length);
            			...
            			break;
            			case (int)99: {
HXLINE(3524)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3528)						::lime::_hx_system::Clipboard_obj::set_text(this->_hx___text.substring(this->_hx___caretIndex,this->_hx___selectionIndex));
            			...
            			break;
            			case (int)118: {
HXLINE(3550)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXDLIN(3569)					( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            			...
            			break;
            			case (int)120: {
HXLINE(3535)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3489)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3506)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3438)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3421)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3455)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3472)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
