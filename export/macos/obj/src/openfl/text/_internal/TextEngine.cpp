...
HXLINE( 328)			 ::openfl::text::Font sans = ( ( ::openfl::text::Font)(processFontList(::Array_obj< ::String >::__new(9)->init(0,(systemFontDirectory + HX_("/Arial.ttf",0c,14,61,7a)))->init(1,(systemFontDirectory + HX_("/Helvetica.ttf",5a,6c,ff,0c)))->init(2,(systemFontDirectory + HX_("/Cache/Arial.ttf",5f,69,b5,54)))->init(3,(systemFontDirectory + HX_("/Cache/Helvetica.ttf",2d,67,e4,7a)))->init(4,(systemFontDirectory + HX_("/Core/Arial.ttf",ba,c6,65,25)))->init(5,(systemFontDirectory + HX_("/Core/Helvetica.ttf",08,0e,fe,0c)))->init(6,(systemFontDirectory + HX_("/CoreAddition/Arial.ttf",d6,48,2f,75)))->init(7,(systemFontDirectory + HX_("/CoreAddition/Helvetica.ttf",24,ce,e8,ab)))->init(8,HX_("/System/Library/Fonts/Supplemental/Arial.ttf",40,75,29,52)))) );
HXLINE( 339)			 ::openfl::text::Font sansBold = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Arial Bold.ttf",f5,90,42,25));
HXLINE( 340)			 ::openfl::text::Font sansItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Arial Italic.ttf",e0,1d,06,bf));
HXLINE( 341)			 ::openfl::text::Font sansBoldItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Arial Bold Italic.ttf",cb,12,c1,33));
HXLINE( 343)			{
HXLINE( 343)				::Dynamic this1 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 343)				( ( ::haxe::ds::StringMap)(this1) )->set(HX_("_sans",32,a0,5e,ff), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,sans,sansBold,sansItalic,sansBoldItalic));
            			}
HXLINE( 345)			 ::openfl::text::Font serif = ( ( ::openfl::text::Font)(processFontList(::Array_obj< ::String >::__new(13)->init(0,(systemFontDirectory + HX_("/Georgia.ttf",67,ae,93,4b)))->init(1,(systemFontDirectory + HX_("/Times.ttf",0f,38,17,67)))->init(2,(systemFontDirectory + HX_("/Times New Roman.ttf",2c,b8,6d,0c)))->init(3,(systemFontDirectory + HX_("/Cache/Georgia.ttf",7a,3e,a6,a3)))->init(4,(systemFontDirectory + HX_("/Cache/Times.ttf",62,8d,6b,41)))->init(5,(systemFontDirectory + HX_("/Cache/Times New Roman.ttf",3f,13,7b,39)))->init(6,(systemFontDirectory + HX_("/Core/Georgia.ttf",95,e8,2c,47)))->init(7,(systemFontDirectory + HX_("/Core/Times.ttf",bd,ea,1b,12)))->init(8,(systemFontDirectory + HX_("/Core/Times New Roman.ttf",5a,d0,31,62)))->init(9,(systemFontDirectory + HX_("/CoreAddition/Georgia.ttf",b1,29,f0,3d)))->init(10,(systemFontDirectory + HX_("/CoreAddition/Times.ttf",d9,6c,e5,61)))->init(11,(systemFontDirectory + HX_("/CoreAddition/Times New Roman.ttf",76,8d,05,b2)))->init(12,HX_("/System/Library/Fonts/Supplemental/Times New Roman.ttf",60,22,07,e2)))) );
HXLINE( 352)			 ::openfl::text::Font serifBold = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Times New Roman Bold.ttf",d5,4f,1d,7d));
HXLINE( 353)			 ::openfl::text::Font serifItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Times New Roman Italic.ttf",c0,54,36,d2));
HXLINE( 354)			 ::openfl::text::Font serifBoldItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Times New Roman Bold Italic.ttf",eb,ef,fd,67));
HXLINE( 356)			{
HXLINE( 356)				::Dynamic this2 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 356)				( ( ::haxe::ds::StringMap)(this2) )->set(HX_("_serif",be,66,15,76), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,serif,serifBold,serifItalic,serifBoldItalic));
            			}
HXLINE( 358)			 ::openfl::text::Font typewriter = ( ( ::openfl::text::Font)(processFontList(::Array_obj< ::String >::__new(9)->init(0,(systemFontDirectory + HX_("/Courier New.ttf",d6,e1,80,a0)))->init(1,(systemFontDirectory + HX_("/Courier.ttf",b6,7e,38,40)))->init(2,(systemFontDirectory + HX_("/Cache/Courier New.ttf",69,77,b8,0d)))->init(3,(systemFontDirectory + HX_("/Cache/Courier.ttf",c9,0e,4b,98)))->init(4,(systemFontDirectory + HX_("/Core/Courier New.ttf",04,cb,ad,96)))->init(5,(systemFontDirectory + HX_("/Core/Courier.ttf",e4,b8,d1,3b)))->init(6,(systemFontDirectory + HX_("/CoreAddition/Courier New.ttf",20,ca,dd,d5)))->init(7,(systemFontDirectory + HX_("/CoreAddition/Courier.ttf",00,fa,94,32)))->init(8,HX_("/System/Library/Fonts/Supplemental/Courier New.ttf",0a,22,a4,92)))) );
HXLINE( 369)			 ::openfl::text::Font typewriterBold = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Courier New Bold.ttf",eb,47,af,10));
HXLINE( 370)			 ::openfl::text::Font typewriterItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Courier New Italic.ttf",56,fe,46,e8));
HXLINE( 371)			 ::openfl::text::Font typewriterBoldItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Courier New Bold Italic.ttf",95,c6,70,a1));
HXLINE( 373)			{
HXLINE( 373)				::Dynamic this3 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 373)				( ( ::haxe::ds::StringMap)(this3) )->set(HX_("_typewriter",0c,5e,52,94), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,typewriter,typewriterBold,typewriterItalic,typewriterBoldItalic));
            			}
            		}
