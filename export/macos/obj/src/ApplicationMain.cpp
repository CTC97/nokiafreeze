...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("nokiajam",b4,81,2c,19),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("17",e6,2a,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Wavyland, NY",17,8e,2e,12));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("nokiajam",b4,81,2c,19));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Find Me In The Snow",8c,8b,87,57));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),672)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),384)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Find Me In The Snow",8c,8b,87,57))
...
HXLINE( 122)		{
HXLINE( 122)			int _g = 0;
HXDLIN( 122)			::Array< ::Dynamic> _g1 = ::ManifestResources_obj::preloadLibraries;
...
HXDLIN( 127)			::Array< ::String > _g3 = ::ManifestResources_obj::preloadLibraryNames;
HXDLIN( 127)			while((_g2 < _g3->length)){
HXLINE( 127)				::String name = _g3->__get(_g2);
