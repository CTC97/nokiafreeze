...
HXLINE(  12)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,0,0,::hx::ClassOf< ::PlayState >(),null(),null(),true,null()));
HXLINE(  13)		::flixel::FlxG_obj::mouse->set_visible(false);
            	}
