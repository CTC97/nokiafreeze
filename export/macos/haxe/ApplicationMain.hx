...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("nokiajam", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("nokiajam", null, 672, 384);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "17";
		app.meta["company"] = "Wavyland, NY";
		app.meta["file"] = "nokiajam";
		app.meta["name"] = "Find Me In The Snow";
